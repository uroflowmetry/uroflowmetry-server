        ...
        {{--<header class="sp-header">--}}
            {{--<div class="sp-logo-wrap pull-left">--}}
                ...
                {{--<a href="#">--}}
                    ...
                    {{--<span class="brand-text">PATIENT SITUATION</span>--}}
                {{--</a>--}}
            {{--</div>--}}
            {{--<div class="form-group mb-0 pull-right">--}}
                {{--<span class="inline-block pr-10">Do not have an account?</span>--}}
                {{--<a class="inline-block btn btn-success  btn-rounded btn-outline" href="{{ url('signUp') }}">Sign Up</a>--}}
            {{--</div>--}}
                        ...
                        <div class="auth-form  ml-auto mr-auto no-float">
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    ...
                                    <div class="mb-30">
                                        <h4 class="text-center txt-dark mb-10">UROFLOWMETRY</h4>
                                        {{-- <p class="text-center"><a class="inline-block btn btn-primary  btn-rounded btn-outline" href="{{ url('app_signin') }}">app user login!</a></p> --}}
                                        <br>
